...
public class Game extends Thread{
	...
	public void run() {
		...
		hitSound = new Audio("src/audio/ShootingGame_src_audio_hitSound.wav", false);
	...
	private void keyProcess() {
		...
		if(shooting && cnt % 15 == 0) {
			playerAttack = new PlayerAttack(playerX + 222, playerY + 20);
	...
	public void infoDraw(Graphics g) {
		...
		g.drawString("Press R to restart", 295, 330);
		}
	}
